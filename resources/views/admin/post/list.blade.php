                ...
                <table class="table table-striped table-bordered table-hover" id="example">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            @if(Auth::user()->role=='admin')
                                @if($post->hot==1)
                                    <td class="text-center hot"><i  class="fa fa-check-square-o " aria-hidden="true"> On</i></td>
                                @else
                                    <td class="text-center hot"><i class="fa fa-ban" aria-hidden="true"> Off</i></td>
                                @endif
                            @endif
                            @if($post->status==1)
                                <td class="text-center status"><i  class="fa fa-check-square-o " aria-hidden="true"> On</i></td>
                            @else
                                <td class="text-center status"><i class="fa fa-ban" aria-hidden="true"> Off</i></td>
                            @endif
                            <td>
        ...
        $('.status').click(function(event) {
            ...
            .done(function(data) {
                if(data=='ok'){
                    ...
                    if(status == 1){
                        div.html('<i class="fa fa-check-square-o " aria-hidden="true"> On</i>');
                    } else  div.html('<i class="fa fa-ban" aria-hidden="true"> Off</i>');
                } else {
                    $.alert(data,{
        ...
        $('.hot').click(function(event) {
            ...
            .done(function(data) {
                if(data=='ok'){
                    ...
                    if(hot == 1){
                        divn.html('<i class="fa fa-check-square-o " aria-hidden="true"> On</i>');
                    } else  divn.html('<i class="fa fa-ban" aria-hidden="true"> Off</i>');
                } else {
                    $.alert(data,{
                        autoClose: true,  closeTime: 3000, type: 'danger',
                        position: ['top-right', [45, 30]],
